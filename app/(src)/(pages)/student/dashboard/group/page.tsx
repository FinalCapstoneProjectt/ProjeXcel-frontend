...
export default function GroupPage() {
  ...
  const [hasTeam, setHasTeam] = useState(true); // Toggle to see no-team state
  ...
  const handleInviteMember = () => {
    ...
    toast({
      ...
      description: `Invitation sent to ${student?.name || inviteEmail}. They will be notified.`,
    });
