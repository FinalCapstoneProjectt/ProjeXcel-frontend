            ...
            <div className="mx-auto mt-10 max-w-5xl animate-in fade-in slide-in-from-bottom-4 duration-700">
              <div className="flex flex-col gap-4 sm:flex-row p-3 bg-white rounded-3xl shadow-xl shadow-primary/5 border">
                ...
                <Select defaultValue="All Departments">
                  <SelectTrigger className="w-full sm:w-64 rounded-2xl border-none bg-muted/50 h-12">
          ...
          <div className="container mx-auto px-4">
            <div className="mb-8 flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Browse the latest contributions from our students
                </p>
              </div>
            ...
            <div className="mt-20 text-center space-y-4">
              <p className="text-sm text-muted-foreground font-medium">
                Viewing 12 of {publicProjects.length} projects
              </p>
              <Button variant="outline" size="lg" className="rounded-full px-12 h-14 border-primary/30 hover:bg-primary/5 text-primary font-bold">
                View All Archives
              </Button>
            </div>
          </div>
